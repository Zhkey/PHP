...
case "insert":
	...
	<form action='?action=save&id=<?php echo $id?>&iframe=1' method='post'  onsubmit='return check()' class='myform' style='width:420px;height:230px;'>
